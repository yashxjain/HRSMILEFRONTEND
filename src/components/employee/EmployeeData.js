        ...
        const fetchData = async () => {
            ...
            try {
                const [employeeResponse, leaveResponse, expenseResponse, attendanceResponse, assetResponse,salaryResponse] = await Promise.all([
                    ...
                    axios.get(`https://namami-infotech.com/HR-SMILE-BACKEND/src/salary/get_salary.php?EmpId=${EmpId}`)
                ]);
    ...
    const handleAddSalary = async () => {
        try {
            const response = await axios.post(
                'https://namami-infotech.com/HR-SMILE-BACKEND/src/salary/add_salary.php',
                { EmpId,
        ...
        insurance: newSalary.insurance, }
            ...
            if (response.data.success) {
                ...
                const updatedSalaryResponse = await axios.get(
                    `https://namami-infotech.com/HR-SMILE-BACKEND/src/salary/get_salary.php?EmpId=${EmpId}`
                );
