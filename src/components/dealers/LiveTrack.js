...
function LiveTrack() {
  ...
  try {
    const url = `https://namami-infotech.com/HR-SMILE-BACKEND/src/track/get_location.php?emp_id=${selectedEmpId}`;
  ...
  try {
    const url = `https://namami-infotech.com/HR-SMILE-BACKEND/src/attendance/view_attendance.php?EmpId=${selectedEmpId}`;
    const response = await axios.get(url);
