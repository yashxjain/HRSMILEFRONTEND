...
const RegulariseList = () => {
    ...
    const fetchRegularisations = async () => {
        try {
            ...
            const response = await axios.get('https://namami-infotech.com/HR-SMILE-BACKEND/src/attendance/get_regularise.php', { params });
    ...
    const handleStatusChange = async (status) => {
        ...
        try {
            ...
            const response = await axios.post('https://namami-infotech.com/HR-SMILE-BACKEND/src/attendance/update_regularise.php', {
