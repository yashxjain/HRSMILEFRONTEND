    ...
    return (
        ...
        <Box sx={{ padding: 2 }}>
            ...
            <Box sx={{ display: 'flex', gap: 2, mb: 2 }}>
                ...
                <Button variant="contained" onClick={exportSummaryToCSV} size="small" sx={{ backgroundColor: '#1B3156' }}>
                     Summary  <GetAppIcon/>
                </Button>
                <Button variant="contained" onClick={exportDetailToCSV} size="small" sx={{ backgroundColor: '#1B3156' }}>
                     Detailed  <GetAppIcon/>
                </Button>
            </Box>
