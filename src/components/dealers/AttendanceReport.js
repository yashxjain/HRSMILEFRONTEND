...
const AttendanceReport = () => {
    ...
    useEffect(() => {
        ...
        const fetchAttendance = async () => {
            try {
                const response = await axios.get('https://namami-infotech.com/HR-SMILE-BACKEND/src/attendance/get_attendance.php');
                if (response.data.success) {
        ...
        <Box sx={{ padding: 2 }}>
            ...
            <Box sx={{ display: 'flex', gap: 2, mb: 2 }}>
                ...
                <TextField
                    ...
                    InputLabelProps={{ shrink: true }}
                />
                <Button variant="contained" onClick={exportAttendanceToCSV} size="small" style={{ backgroundColor: '#1B3156' }}>
                    <GetAppIcon />
                </Button>
            </Box>
